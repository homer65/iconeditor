...
public class Parameter 
{
	...
	// public static int pixelPanelSize = 8;
	...
	public static double gainDefault = 1.05;
	public static double bias = -12.75;
	public static double biasDefault = -12.75;
	public static double rmax = 0.999;
	public static double rmaxDefault = 0.999;
	public static double rmin = 0.6;
	public static double rminDefault = 0.6;
}
